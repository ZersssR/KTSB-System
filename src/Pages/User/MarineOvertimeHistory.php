...
<head>
    ...
    <title>Marine Overtime History</title>
                ...
                <div class="mx-auto max-w-7xl">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Marine Overtime</span>
                        </nav>
                    </div>
                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="search" name="search"
                                        ...
                                        placeholder="Search Request No or Company..."
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    $stmt = $conn->prepare("SELECT overtime_id, company_name, request_date, request_time, status, created_at FROM marine_overtime_requests $whereClause ORDER BY created_at DESC LIMIT $results_per_page OFFSET $offset");
                                    $stmt->execute($params);
                                    ...
                                    if (count($results) > 0) {
                                        ...
                                        foreach ($results as $row) {
                                            ...
                                            echo "<tr class='clickable-row' data-id='" . $row['overtime_id'] . "' style='cursor: pointer;' onclick=\"window.location.href='marine-overtime-detail.php?id=" . $row['overtime_id'] . "'\">";
                                            echo "<td>" . $no++ . "</td>";
                                        ...
                                        echo "<tr><td colspan='6'>No marine overtime history found.</td></tr>";
                                    }
