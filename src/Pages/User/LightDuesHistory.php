...
<head>
    ...
    <title>Light Dues History</title>
                ...
                <div class="mx-auto max-w-7xl">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Light Dues</span>
                        </nav>
                    </div>
                    ...
                    <div class="mb-8">
                        <?php if ($currentUser['role'] === 'agent'): ?>
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mt-2 text-base font-normal leading-normal">Complete
                                list of port light records for vessels.</p>
                        <?php else: ?>
                            <h2
                                class="text-[#212529] dark:text-gray-100 text-4xl font-black leading-tight tracking-[-0.033em]">
                                Light Dues History</h2>
                            <p class="text-gray-600 dark:text-gray-400 mt-2 text-base font-normal leading-normal">Review
                                historical light dues records for vessels.</p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-6">
                        <div
                            ...
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-[#212529] dark:text-gray-200">Filter Light Dues
                                </h3>
                            </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    $whereConditions = [];
                                    $whereConditions[] = "request_type = 'light_dues'";
                                    $params = [];
                                    ...
                                    if (count($results) > 0) {
                                        ...
                                        foreach ($results as $row) {
                                            echo "<tr class='clickable-row' data-id='" . $row['lightport_id'] . "' style='cursor: pointer;' onclick=\"window.location.href='light-dues-detail.php?id=" . $row['lightport_id'] . "'\">";
                                            echo "<td>" . $no++ . "</td>";
                                        ...
                                        echo "<tr><td colspan='6'>No light dues history found.</td></tr>";
                                    }
