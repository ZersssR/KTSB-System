                ...
                <div class="mx-auto max-w-7xl">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Pending Endorsements</span>
                        </nav>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    // Build WHERE clause - only show pending endorsement requests
                                    $whereConditions = ["status = 'pending endorsement'"];
                                    $params = [];
                                    ...
                                    $whereClause = !empty($whereConditions) ? 'WHERE ' . implode(' AND ', $whereConditions) : 'WHERE status = "pending endorsement"';
                                    ...
                                    if (count($results) > 0) {
                                        ...
                                        echo "<tr><td colspan='10' class='text-center py-8 text-gray-500'>No pending endorsement requests found.</td></tr>";
                                    }
                                } catch (PDOException $e) {
                                    echo "<tr><td colspan='10' class='text-center py-8 text-red-500'>Error loading endorsements: " . htmlspecialchars($e->getMessage()) . "</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            clickableRows.forEach(row => {
                row.addEventListener('click', function () {
                    ...
                    // Navigate to endorse_marine.php instead of marine-detail.php
                    window.location.href = 'endorse_marine.php?id=' + id;
                });
            });
        });
