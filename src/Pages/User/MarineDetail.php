...
$currentPage = 'marine-history.php';
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        /* Status pill styles from endorse_marine.php */
        .status-pill {
        ...
        /* Standardized typography from endorse_marine.php */
        ...
        /* BOD number highlight from endorse_marine.php */
        ...
        /* Attendance badges from endorse_marine.php */
        .attendance-badge {
            display: inline-flex;
            align-items: center;
            gap: 0.25rem;
        ...
        <div class="flex flex-1 flex-col lg:ml-64 pt-16">
            <main class="flex-1 overflow-y-auto p-4 md:p-8">
                <div class="mx-auto max-w-7xl">
                    ...
                    try {
                        // Updated query to include endorser and amendment requester information
                        $query = "SELECT mr.*, 
                        ...
                        if ($currentUser['role'] === 'agent') {
                            $query .= " AND mr.assigned_agent_id = ?";
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            <?php if ($currentUser['role'] === 'admin'): ?>
                                <a href="admin/marine_requests.php" class="hover:text-primary">Request List</a>
                                <span class="mx-2">/</span>
                                <a href="admin/marine_requests.php" class="hover:text-primary">Marine</a>
                            <?php else: ?>
                                <a href="marine-history.php" class="hover:text-primary">History</a>
                                <span class="mx-2">/</span>
                                <a href="marine-history.php" class="hover:text-primary">Marine</a>
                            <?php endif; ?>
                            <span class="mx-2">/</span>
                    ...
                    <div class="mb-8">
                        ...
                        <!-- Status Pill - Large style from endorse_marine.php -->
                        <div class="mt-4 flex items-center gap-4 flex-wrap">
                            <?php
                            $statusClass = 'status-' . str_replace(' ', '-', strtolower($request['status']));
                            ?>
                        ...
                        <?php if ($request['status'] === 'endorsed' && $request['endorsed_by']): ?>
                        <div class="mt-4 flex flex-wrap gap-4">
                            <div class="flex items-center gap-3 bg-green-50 text-green-800 px-4 py-2.5 rounded-xl border border-green-200 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold"><?php echo htmlspecialchars($request['endorser_name'] ?: 'User ID: ' . $request['endorsed_by']); ?></p>
                                    <p class="text-xs text-green-600 mt-0.5">
                                        <?php echo $request['endorsed_at'] ? date('d/m/Y H:i', strtotime($request['endorsed_at'])) : ''; ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php if ($request['status'] === 'request amendment' && $request['amendment_requested_by']): ?>
                        <div class="mt-4 flex flex-wrap gap-4">
                            <div class="flex items-center gap-3 bg-red-50 text-red-800 px-4 py-2.5 rounded-xl border border-red-200 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold"><?php echo htmlspecialchars($request['amendment_requester_name'] ?: 'User ID: ' . $request['amendment_requested_by']); ?></p>
                                    <p class="text-xs text-red-600 mt-0.5">
                                        <?php echo $request['amendment_requested_at'] ? date('d/m/Y H:i', strtotime($request['amendment_requested_at'])) : ''; ?>
                                    </p>
                                </div>
                            </div>
                            
                            <?php if (!empty($request['amendment_notes'])): ?>
                            <div class="flex-1 bg-gray-50 rounded-xl p-4 border border-gray-200">
                                ...
                                <p class="text-sm text-gray-800"><?php echo nl2br(htmlspecialchars($request['amendment_notes'])); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
                    ...
                    <!-- Details Card - Using same styling as endorse_marine.php -->
                                ...
                                <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-200 min-h-[340px] flex flex-col">
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-3 gap-4 items-center">
                                            ...
                                            <span class="text-sm font-semibold text-gray-900 col-span-2"><?php echo htmlspecialchars($request['company'] ?: 'N/A'); ?></span>
                                        </div>
                                        <div class="grid grid-cols-3 gap-4 items-center">
                                        ...
                                        <div class="grid grid-cols-3 gap-4 items-center">
                                            ...
                                            <span class="text-sm font-semibold text-gray-900 col-span-2"><?php echo htmlspecialchars($assignedAgent); ?></span>
                                        </div>
                                        <div class="grid grid-cols-3 gap-4 items-center">
                    ...
                    <!-- File Upload Section - Same as endorse_marine.php -->
                    ...
                    <!-- Back Button - Styled like endorse_marine.php back button -->
                    <div class="mt-10 flex justify-start">
                        <a href="<?php echo $currentUser['role'] === 'admin' ? 'admin/marine_requests.php' : 'marine-history.php'; ?>" 
                           class="group inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-white text-gray-700 rounded-xl border border-gray-300 font-medium text-sm hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm hover:shadow-md">
                            ...
                            BACK TO <?php echo $currentUser['role'] === 'admin' ? 'REQUESTS' : 'HISTORY'; ?>
                        </a>
                    </div>
                </div>
            </main>
