...
<head>
    ...
    <title>Crew Sign Off Requests List</title>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Crew Sign Off Requests</span>
                        </nav>
                    </div>
                        ...
                        <div
                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="crew_sign_off_requests.php"
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                // Assuming crew_sign_off_requests has user_id, 
                                // joining with users for username
                                $sql = "SELECT csor.*, u.username as requestor_name 
                        FROM crew_sign_off_requests csor 
                        LEFT JOIN users u ON csor.user_id = u.user_id 
                        $whereClause 
                        ORDER BY csor.request_date DESC, csor.request_time DESC
                        LIMIT $results_per_page OFFSET $offset";
                                ...
                                if (count($results) > 0) {
                                    ...
                                    echo "<tr><td colspan='5' class='text-center py-4'>No requests found.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(row => {
                row.addEventListener('click', function () {
                    window.location.href = '../sign-off-detail.php?id=' + this.dataset.id;
                });
            });
        });
    </script>
