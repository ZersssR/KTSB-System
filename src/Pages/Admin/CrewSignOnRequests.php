...
<head>
    ...
    <title>Crew Sign On Requests List</title>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Crew Sign On Requests</span>
                        </nav>
                    </div>
                        ...
                        <div
                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="crew_sign_on_requests.php"
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                // Assuming crew_sign_on_requests has user_id and vessel_name
                                $sql = "SELECT csor.*, u.username as requestor_name 
                        FROM crew_sign_on_requests csor 
                        LEFT JOIN users u ON csor.user_id = u.user_id 
                        $whereClause 
                        ORDER BY csor.created_at DESC 
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(row => {
                row.addEventListener('click', function () {
                    window.location.href = '../sign-on-detail.php?id=' + this.dataset.id;
                });
            });
        });
    </script>
