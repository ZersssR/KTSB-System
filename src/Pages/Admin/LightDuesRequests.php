...
$currentPage = 'light_dues_requests.php';
?>
...
<head>
    ...
    <title>Light Dues Requests List</title>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Light Dues Requests</span>
                        </nav>
                    </div>
                        ...
                        <div
                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="light_dues_requests.php"
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                $countWhereConditions[] = "request_type = 'light_dues'";
                                if (!empty($_GET['status_filter'])) {
                                ...
                                // Fetch data - using the light_port_requests table directly
                                $sql = "SELECT 
                                    lightport_id, 
                                    vessel_name, 
                                    company_name, 
                                ...
                                if (count($results) > 0) {
                                    ...
                                    foreach ($results as $row) {
                                        ...
                                        $requestDate = !empty($row['request_date']) ? date('d/m/Y', strtotime($row['request_date'])) : 'N/A';
                                        
                                        // Format time - handle different time formats
                                        $requestTime = 'N/A';
                                        if (!empty($row['request_time'])) {
                                            if (strpos($row['request_time'], ':') !== false) {
                                                // If it's already in time format
                                                $requestTime = date('H:i', strtotime($row['request_time']));
                                            } else {
                                                // If it's stored differently
                                                $requestTime = date('H:i', strtotime($row['request_time']));
                                            }
                                        }
                                    ...
                                    echo "<tr><td colspan='7' class='text-center py-4'>No light dues requests found.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
                                ...
                                <div>
                                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm"
                                        ...
                                        for ($i = 1; $i <= $total_pages; $i++) {
                                            ...
                                            echo "<a href='?page=$i$queryString' class='relative inline-flex items-center px-4 py-2 text-sm font-semibold $active focus:z-20'>$i</a>";
                                        }
                                        ?>
                                    </nav>
                                </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(row => {
                row.addEventListener('click', function () {
                    window.location.href = '../admin/light_dues_detail.php?id=' + this.dataset.id;
                });
            });
        });
    </script>
