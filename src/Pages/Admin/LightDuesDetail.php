                ...
                <div class="mx-auto max-w-7xl">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <?php else: ?>
                                <a href="light-dues-history.php" class="hover:text-primary">History</a>
                                <span class="mx-2">/</span>
                                <a href="light-dues-history.php" class="hover:text-primary">Light Dues</a>
                            <?php endif; ?>
                            <span class="mx-2">/</span>
                            <span
                    ...
                    <div class="w-full bg-white rounded-xl shadow-sm p-6 md:p-8">
                        <div class="grid md:grid-cols-2 gap-x-12 gap-y-8">
                            ...
                            <section class="marine-detail-section">
                                <h3>Light Dues Service Details</h3>
                                <div class="space-y-4">
                                    <div
                    ...
                    <div class="mt-6 flex flex-wrap gap-3">
                        <?php if ($currentUser['role'] === 'admin'): ?>
                                <a href="Light_dues_requests.php"
                                    ...
                                    Back to Light Dues Requests
                                </a>
                                <a href="light_dues_edit.php?lightport_id=<?php echo htmlspecialchars($id); ?>"
