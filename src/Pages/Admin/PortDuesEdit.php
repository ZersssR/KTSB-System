<?php
// Protected port dues edit page - requires authentication
...
// Fetch port dues request details
try {
    ...
    if (!$request) {
        echo "<p>Port dues request not found.</p>";
        exit;
    }
    ...
    // Fetch all customers for dropdown - CHANGED FROM companies TO customers
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $success = $updateStmt->execute([
            ...
            $services,
            $volume_unit,
            $currentUser['user_id'], // Add current user ID as updater
            $lightport_id
        ]);
        
        if ($success) {
            // Success message
            $successMessage = "Port dues request updated successfully!";
            ...
            header("Refresh: 2; URL=light_port_detail.php?id=" . $lightport_id);
        } else {
...
<head>
    ...
    <title>Edit Port Dues Request</title>
                ...
                <div class="mx-auto max-w-4xl">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="mx-2">/</span>
                            <a href="light_port_detail.php?id=<?php echo htmlspecialchars($request['lightport_id'] ?? ''); ?>" 
                               class="hover:text-primary">Port Dues Detail</a>
                            <span class="mx-2">/</span>
                    ...
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . '?lightport_id=' . $lightport_id; ?>" class="space-y-6">
                        <div class="bg-white rounded-xl shadow-sm p-6 md:p-8">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                ...
                                <!-- Company (Editable Dropdown) - NOW FROM CUSTOMERS TABLE -->
                                <div>
                                    ...
                                    <div class="select-wrapper">
                                        <select id="company_name" name="company_name" class="form-input" required>
                                            ...
                                            <?php foreach ($customers as $customer): ?>
                                                ...
                                                $isTemporary = ($customer['id'] == 0); // Temporary company from light_port_requests
                                ...
                                <!-- Services (Editable - from original data) -->
                                <div>
                                ...
                                <!-- Volume/Unit (Editable - from original data) -->
                                <div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-6 md:p-8">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                ...
                                <!-- Updated By (Non-editable - shows current admin) -->
                                <div>
...
<div class="flex flex-wrap gap-3">
    <button type="button" 
            onclick="window.location.href='port_dues_requests.php'"
