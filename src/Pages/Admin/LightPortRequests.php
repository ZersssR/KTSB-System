...
<head>
    ...
    <title>Light Port Requests List</title>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Light Port Requests</span>
                        </nav>
                    </div>
                        ...
                        <div
                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="light_port_requests.php"
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                if (!empty($_GET['search'])) {
                                    ...
                                    $whereConditions[] = "(lightport_id LIKE ? OR vessel_name LIKE ?)";
                                    $params[] = $searchTerm;
                                    $params[] = $searchTerm;
                                }
                                ...
                                // Assuming light_port_requests has user_id, 
                                // joining with users for username
                                $sql = "SELECT lpr.*, u.username as requestor_name 
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(row => {
                row.addEventListener('click', function () {
                    window.location.href = '../light-port-detail.php?id=' + this.dataset.id;
                });
            });
        });
    </script>
