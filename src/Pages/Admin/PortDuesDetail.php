                            ...
                            <section class="marine-detail-section">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="text-xs text-gray-500 mt-4 space-y-1">
                                        <p><span class="font-medium">Request by:</span>
                                            <?php 
                                            $requestBy = '';
                                            ...
                                            echo htmlspecialchars($requestBy);
                                            ?>
                                        </p>
                                        ...
                                        <p><span class="font-medium">Updated by:</span>
                                            <?php 
                                            $updatedBy = '';
                                            if (!empty($request['updated_by_name'])) {
                                                $updatedBy = $request['updated_by_name'];
                                            } elseif (!empty($request['updated_by_username'])) {
                                                $updatedBy = $request['updated_by_username'];
                                            } elseif ($request['created_at'] != $request['updated_at']) {
                                                $updatedBy = 'Admin';
                                            } else {
                                                $updatedBy = 'Not updated';
                                            }
                                            echo htmlspecialchars($updatedBy);
                                            ?>
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="mt-6 flex flex-wrap gap-3">
                        <?php if ($currentUser['role'] === 'admin'): ?>
                                <a href="port_dues_requests.php"
                                    ...
                                    Back to Port Dues Requests
                                </a>
                                <a href="port_dues_edit.php?lightport_id=<?php echo htmlspecialchars($id); ?>"
