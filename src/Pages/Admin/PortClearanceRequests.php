...
$currentPage = 'port_clearance_requests.php';
?>
...
<head>
    ...
    <title>Port Clearance Requests List</title>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Port Clearance Requests</span>
                        </nav>
                    </div>
                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="search"
                                        ...
                                        placeholder="Search Clearance No..."
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                // Fetch data
                                // Assuming port_clearance_requests has columns: clearance_id, vessel_name, company_name, created_at, request_date, request_time, status
                                $sql = "SELECT pcr.*, u.username as requestor_name 
                        ...
                        LIMIT $results_per_page OFFSET $offset";
                                ...
                                if (count($results) > 0) {
                                    ...
                                    foreach ($results as $row) {
                                        echo "<tr class='clickable-row' data-id='" . $row['clearance_id'] . "' style='cursor: pointer;'>";
                                        echo "<td>" . $no++ . "</td>";
                                    ...
                                    echo "<tr><td colspan='7' class='text-center py-4'>No requests found.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(row => {
                row.addEventListener('click', function () {
                    window.location.href = 'port_clearance_detail.php?id=' + this.dataset.id;
                });
            });
        });
    </script>
