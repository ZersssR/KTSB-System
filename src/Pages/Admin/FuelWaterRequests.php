...
<head>
    ...
    <title>Fuel & Water Requests List</title>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Fuel & Water Requests</span>
                        </nav>
                    </div>
                        ...
                        <div
                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="fuel_water_requests.php"
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                // Assuming fuel_water_requests has user_id
                                $sql = "SELECT fwr.*, u.username as requestor_name 
                        FROM fuel_water_requests fwr 
                        LEFT JOIN users u ON fwr.user_id = u.user_id 
                        $whereClause 
                        ORDER BY fwr.request_date DESC, fwr.request_time DESC 
                        LIMIT $results_per_page OFFSET $offset";
                                ...
                                if (count($results) > 0) {
                                    ...
                                    foreach ($results as $row) {
                                        ...
                                        echo "<td>" . htmlspecialchars($row['requestor_name'] ?? 'Unknown') . "</td>";
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            rows.forEach(row => {
                row.addEventListener('click', function () {
                    window.location.href = '../fuel-water-detail.php?id=' + this.dataset.id;
                });
            });
        });
    </script>
