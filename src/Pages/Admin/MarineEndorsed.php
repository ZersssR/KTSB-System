...
<head>
    ...
    <title>Endorsed Marine Requests</title>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-[#212529] dark:text-gray-200">Endorsed Marine Requests</span>
                        </nav>
                    </div>
                    ...
                    <div class="mb-8">
                        <h2
                            ...
                            Endorsed Marine Requests</h2>
                        <p class="text-gray-600 dark:text-gray-400 mt-2 text-base font-normal leading-normal">List of all marine requests that have been endorsed.</p>
                    </div>
                    ...
                    <div class="mb-6">
                        <div
                            ...
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-[#212529] dark:text-gray-200">Filter Endorsed Requests</h3>
                            </div>
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                <?php
                                // Build WHERE conditions for main query - ONLY ENDORSED REQUESTS
                                $whereConditions = ["mr.status = 'endorsed'"];
                                $params = [];
                                ...
                                if (!empty($month)) {
                                    $whereConditions[] = "MONTH(mr.endorsed_at) = ?";
                                    $params[] = $month;
                                }
                                if (!empty($year)) {
                                    $whereConditions[] = "YEAR(mr.endorsed_at) = ?";
                                    $params[] = $year;
                                }
                                ...
                                // Main query to fetch marine requests - ONLY ENDORSED
                                $sql = "SELECT mr.*, 
                                            u.username, 
                                            u.full_name,
                                ...
                                if (count($results) > 0) {
                                    ...
                                    foreach ($results as $row) {
                                        ...
                                        $endorsed_at = !empty($row['endorsed_at']) ? date('d/m/Y H:i', strtotime($row['endorsed_at'])) : '';
                                        ...
                                        echo "<td>" . htmlspecialchars($endorsed_at) . "</td>";
                                        echo "<td><span class='status-pill status-$statusClass'>" . htmlspecialchars(ucwords($row['status'])) . "</span></td>";
                                        echo "</tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='10' class='text-center py-8 text-gray-500 dark:text-gray-400'>No endorsed marine requests found.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
                    ...
                    <?php if ($total_pages > 1): ?>
                        <div
                            ...
                            <div class="flex flex-1 justify-between sm:hidden">
                                <!-- Mobile pagination -->
                                <?php if ($page > 1): ?>
                                    <a href="?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>"
                                ...
                                <div>
                                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm"
                                        ...
                                        for ($i = 1; $i <= $total_pages; $i++) {
                                            ...
                                            echo "<a href='?page=$i&search=" . urlencode($search) . "&month=$month&year=$year' class='relative inline-flex items-center px-4 py-2 text-sm font-semibold $active focus:z-20'>$i</a>";
                                        }
                                        ?>
                                    </nav>
                                </div>
