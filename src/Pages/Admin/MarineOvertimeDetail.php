<?php
// Protected marine-overtime-detail page - requires authentication
...
<head>
    ...
    <title>Marine Overtime Detail</title>
        ...
        <div class="flex flex-1 flex-col lg:ml-64 pt-16">
            <main class="flex-1 overflow-y-auto p-4 md:p-8">
                <div class="mx-auto max-w-7xl">
                    ...
                    try {
                        $query = "SELECT * FROM marine_overtime_requests WHERE overtime_id = ?";
                        $params = [$id];
                    ...
                    <div class="mb-4">
                        <nav class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <?php else: ?>
                                <a href="marine-overtime-history.php" class="hover:text-primary">History</a>
                                <span class="mx-2">/</span>
                                <a href="marine-overtime-history.php" class="hover:text-primary">Marine Overtime</a>
                            <?php endif; ?>
                            <span class="mx-2">/</span>
                            <span
                                class="text-[#212529] dark:text-gray-200"><?php echo htmlspecialchars($request['overtime_id']); ?></span>
                        </nav>
                    </div>
                    ...
                    <div class="w-full bg-white rounded-xl shadow-sm p-6 md:p-8">
                        <div class="grid md:grid-cols-2 gap-x-12 gap-y-8">
                            ...
                            <!-- Section 2: Vessels & Receipt Details -->
                            <section class="marine-detail-section">
                                <h3>Vessels & Receipt Details</h3>
                                <div class="space-y-4">
                                    <div
                                        ...
                                        <ul
                                            class="list-disc list-inside text-xs text-gray-600 dark:text-gray-400 space-y-1">
                                            <?php foreach ($vessels as $vessel): ?>
                                                <li><?php echo htmlspecialchars($vessel); ?></li>
                                            <?php endforeach; ?>
                                            <?php if (empty($vessels))
                                                echo "<li>No vessels listed.</li>"; ?>
                                        </ul>
                                    </div>

                                    <div class="space-y-1 text-xs mt-4">
                                        <p><span class="font-medium text-gray-600 dark:text-gray-400">Receipt No:</span>
                                            <?php echo htmlspecialchars($request['receipt_no'] ?: '-'); ?></p>
                                        <p><span class="font-medium text-gray-600 dark:text-gray-400">Remarks:</span>
                                            <?php echo htmlspecialchars($request['remarks'] ?: '-'); ?></p>
                                    </div>

                                    <!-- Initial Receipt Files Display -->
                                    <?php if (!empty($initialReceipts)): ?>
                                        <div class="mt-4">
                                            <h4 class="text-sm font-semibold text-gray-900 mb-2">Initial Receipts</h4>
                                            <div class="space-y-2">
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            const requestType = 'marine_overtime';
                            let selectedFiles = [];
                    ...
                    <div class="mt-6 flex flex-wrap gap-3">
                        <?php if ($currentUser['role'] === 'admin'): ?>
                                <a href="marine_overtime_requests.php"
                                    ...
                                    Back to Marine Overtime Requests
                                </a>
                                <a href="marine_overtime_edit.php?overtime_id=<?php echo htmlspecialchars($id); ?>"
