<?php
// require_once __DIR__ . '/config/database.php'; // Commented out to prevent die() from stopping the script
...
// Passwords to try
$passwords = ['', 'root', 'mysql', 'admin', '1234', '123456', 'password', 'toor', 'ktsb', 'ktsb123', 'admin123'];
$host = '127.0.0.1';
